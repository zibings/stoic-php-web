<?php
	...
	/**
	 * Exception that signifies headers were already sent by the currently executing script.
	 *
	 * @package Stoic\Web
	 * @version 1.1.0
	 */
	class HeadersAlreadySentException extends \Exception {
		...
		/**
		 * Instantiates a new HeadersAlreadySent exception with the list of headers sent pre-populated.
		 *
		 * @param string $message The Exception message to throw.
		 * @param int $code The Exception code.
		 * @param null|\Throwable $previous The previous Exception used for chaining.
	...
	/**
	 * Exception that signifies no JSON input is available when JSON input is requested.
	 *
	 * @package Stoic\Web
	 * @version 1.1.0
	 */
